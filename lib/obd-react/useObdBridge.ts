...
import { bridgeBaseUrl, createHttpObdClient } from '@/lib/obd/httpClient';
import { createWebSerialClient, webSerialAvailable } from '@/lib/obd/webSerial';
import { createElectronObdClient } from '@/lib/obd/electronClient';
