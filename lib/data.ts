...
export const COMPONENTS: Component[] = [
  ...
  { id: 'brakefluid', label: 'Brake Fluid Reservoir', sub: 'Master cylinder · ABS', system: 'Brakes', diff: 2, time: '~45 min',
    part: 'DOT 4 · reservoir 981.355.301', spec: 'DOT 4 / Class 6 · level between MIN/MAX', interval: 'Fluid 2 yr', torque: 'Bleed nipples 10 Nm',
  ...
  { id: 'washer', label: 'Washer Reservoir', sub: 'Front service bay', system: 'Body', diff: 1, time: '~10 min',
    part: 'Reservoir 981.628.031 · pump 7PP.955.651', spec: '~3 L · freeze-rated mix', interval: 'Top up as needed', torque: 'n/a',
  ...
  { id: 'suspension', label: 'Front Struts & Arms', sub: 'MacPherson · ARB', system: 'Steering', diff: 4, time: 'shop',
    part: 'Strut 981.343.041 · control arm 981.341.017', spec: 'MacPherson front · hydraulic bushings', interval: 'Inspect yearly / after track', torque: 'Strut top 80 Nm · arm bolts 90 Nm + 90°',
